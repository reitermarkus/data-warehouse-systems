...
Segment is a customer data platform for collecting, cleaning and controlling data flow across multiple services in one central location. It offers a \textit{Free} plan which supports two data sources and 300+ integrations, a \textit{Team} plan starting at \$120/month for 10 users with unlimited data sources and 10,000 API calls up to \$1,125/month for 100,000 API calls. They also offer a \textit{Business} plan for custom usage requirements. The scalable \textit{Team} plan should be sufficient for most SMEs.
